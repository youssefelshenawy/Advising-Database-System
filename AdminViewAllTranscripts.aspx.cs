...
{
    public partial class AdminViewAllTranscripts : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string connectionString =
WebConfigurationManager.ConnectionStrings["DBAdvising_System"].ConnectionString;
            string selectSQL = "SELECT *  FROM Students_Courses_transcript";
            ...
            adapter.Fill(ds, "Students_Courses_transcript");
            if (IsEmpty(ds))
            {

...
{
    public partial class AdminViewAllSemester : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string connectionString =
WebConfigurationManager.ConnectionStrings["DBAdvising_System"].ConnectionString;
            string selectSQL = "SELECT *  FROM Semster_offered_Courses";
            ...
            adapter.Fill(ds, "Semster_offered_Courses");
            if (IsEmpty(ds))
            {

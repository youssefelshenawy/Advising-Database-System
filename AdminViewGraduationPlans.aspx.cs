...
{
    public partial class AdminViewGraduationPlans : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string connectionString =
WebConfigurationManager.ConnectionStrings["DBAdvising_System"].ConnectionString;
            string selectSQL = "SELECT *  FROM Advisors_Graduation_Plan";
            ...
            adapter.Fill(ds, "Advisors_Graduation_Plan");
            if (IsEmpty(ds))
            {
